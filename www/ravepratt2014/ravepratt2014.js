    	...
    	var data = [{
			...
			description: "A 12 year old orphan fascinated by technology.",
     		quests: [{
				...
				story: [{
					background: "bg0.png",
					text: ["Maritime Society?  I wonder what that is?", ""]
				}, {
					background: "bg1.png",
					text: ["I enjoy sports!"]
				}, {
     			...
     			question: "What does the bowl say?",
				image: "stories_questions/question2.png",
				answers: ["England", "Maritime Society", "Maritime Association", "English Maritime"],
				correctAnswer: "Maritime Society",
				hint: "It begins with M",
				correctMessage: ["Right!", "It says, \'Maritime Society\'"]		
			}, {
				story: [{
					background: "bg0.png",
